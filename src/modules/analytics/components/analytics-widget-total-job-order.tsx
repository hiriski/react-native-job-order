...
import { IAnalyticsTotalJobOrderWidget } from '../analytics.interface';

interface Props {
  item: IAnalyticsTotalJobOrderWidget;
}

const { width } = Dimensions.get('screen');

export const AnalyticsWidgetTotalJobOrder: FC<Props> = ({ item }: Props) => {
